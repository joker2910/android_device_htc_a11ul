...
include $(CLEAR_VARS)
LOCAL_MODULE		:= init.target.recovery.rc
LOCAL_MODULE_TAGS	:= optional eng
LOCAL_MODULE_CLASS	:= ETC
LOCAL_SRC_FILES		:= etc/init.target.recovery.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE		:= init.project.recovery.rc
LOCAL_MODULE_TAGS	:= optional eng
LOCAL_MODULE_CLASS	:= ETC
LOCAL_SRC_FILES		:= etc/init.project.recovery.rc
LOCAL_MODULE_PATH	:= $(TARGET_RECOVERY_ROOT_OUT)
include $(BUILD_PREBUILT)
